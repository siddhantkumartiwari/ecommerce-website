  ...
  return (
    <div className="flex items-center justify-between py-5 px-2 rounded-xl shadow-gray-200 font-medium shadow-lg mb-10">
      ...
      <ul className="hidden sm:flex gap-5 text-sm text-gray-700">
        ...
        <NavLink
          to="/ecommerce-website/collection"
          className="flex flex-col items-center gap-1"
        >
          <p>COLLECTION</p>
          <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden" />
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          <Link to="/ecommerce-website/login">
            <img
          ...
          <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
            <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded">
              ...
              <p
                ...
                onClick={() => navigate("/ecommerce-website/orders")}
              >
                Orders
              </p>
        ...
        <Link to="/ecommerce-website/cart" className="relative">
